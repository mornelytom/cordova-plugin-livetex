...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="LivetexCore",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@interface WebSocket (SWIFT_EXTENSION(LivetexCore))
...
SWIFT_PROTOCOL("_TtP11LivetexCore17WebSocketDelegate_")
@protocol WebSocketDelegate
